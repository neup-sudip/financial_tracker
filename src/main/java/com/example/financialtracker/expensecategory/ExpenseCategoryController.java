...
public class ExpenseCategoryController {
    ...
    @GetMapping()
    public ResponseEntity<ApiResponse<List<ExpenseCategoryResDto>>> getAllCategory(){
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<ExpenseCategoryResDto>> getSingleCategory(@PathVariable long id){
        User user = (User) request.getAttribute("user");
    ...
    @PostMapping()
    public ResponseEntity<ApiResponse<ExpenseCategoryResDto>> createCategory(@Valid @RequestBody ExpenseCategoryReqDto expenseCategoryReqDto){
        User user = (User) request.getAttribute("user");
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<ExpenseCategoryResDto>> updateCategory(@Valid @RequestBody ExpenseCategoryReqDto expenseCategoryReqDto, @PathVariable long id){
        User user = (User) request.getAttribute("user");
